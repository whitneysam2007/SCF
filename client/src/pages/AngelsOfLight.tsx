    ...
    <div className="pt-20 md:pt-28">
      ...
      <section className="relative min-h-[70vh] flex items-center overflow-hidden">
        <div className="absolute inset-0">
          <img
            src="/manus-storage/building-school_ff708dac_41961aa7.png"
            ...
            {[
              {
                ...
                img: "/manus-storage/you-give-mother-child_2557e047_babca2de.jpg",
              },
              {
                title: "We Direct",
        ...
        <div className="container">
          ...
          <div className="space-y-16 max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
              <div>
                <img
                  src="/manus-storage/cairo-heba_2d53c88a_a2652365.webp"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
              ...
              <div className="order-1 lg:order-2">
                <img
                  src="/manus-storage/chinese-orphans_00fe62d9_724f5ff9.webp"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
              <div>
                <img
                  src="/manus-storage/disabled-learning-center-v2_b4aee080_ec0f2a3f.png"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
              ...
              <div className="order-1 lg:order-2">
                <img
                  src="/manus-storage/christmas-thailand-v2_85706d92_fc4a63f9.png"
        ...
        <div className="container">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="overflow-hidden rounded-lg">
              <img
                src="/manus-storage/lusaka-3_d337782e_e90b7d10.jpg"
          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 items-start">
              <div className="lg:col-span-2 flex flex-col gap-4">
                <img
                  src="/manus-storage/rising-star-1_f1f91089_2794f970.jpg"
                  alt="Becky with Rising Star Outreach students in India"
                  className="rounded-lg shadow-lg w-full object-cover"
                />
                <img
                  src="/manus-storage/rising-star-2_a5fb59df_a774efb0.jpg"
      ...
      <section className="relative py-20 md:py-24 overflow-hidden">
        <div className="absolute inset-0">
          <img
            src="/manus-storage/children-waving_f0d014ab_84603020.png"
            alt="Children waving"
            className="w-full h-full object-cover"
          />
