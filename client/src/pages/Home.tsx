    ...
    <div>
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden">
        <div className="absolute inset-0">
          <img
            src="https://d36hbw14aib5lz.cloudfront.net/310519663520822653/gck96ofZSr9RHT3ULk9Y66/hi-6_7997798d_011113c0.webp"
        ...
        <div className="relative container pt-24 pb-16 md:pt-32 md:pb-24">
          <div className="max-w-2xl">
            ...
            >
              <Link
                href="/stories"
                className="px-8 py-3.5 bg-[#D4A853] hover:bg-[#c49a45] text-[#12365a] font-body font-bold text-base tracking-wide rounded transition-all hover:shadow-lg hover:shadow-[#D4A853]/20"
              >
                SEE THE IMPACT
              </Link>
              <Link
      ...
      <AnimatedSection className="py-20 md:py-28 bg-[#f5f7fb]">
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 max-w-5xl mx-auto">
            {[
              { icon: Eye, title: "Preventable Blindness", text: "Millions suffer from preventable blindness", img: "https://d36hbw14aib5lz.cloudfront.net/310519663520822653/gck96ofZSr9RHT3ULk9Y66/eye-closeup_d46680f6_d159c660.png", objPos: "" },
              { icon: Baby, title: "Malnutrition", text: "Children face severe malnutrition without access to care", img: "https://d36hbw14aib5lz.cloudfront.net/310519663520822653/gck96ofZSr9RHT3ULk9Y66/malnutrition-photo_24a512e9_f96b0042.png", objPos: "" },
              { icon: Droplets, title: "Lack of Clean Water", text: "Clean water and sanitation remain inaccessible in many regions", img: "https://d36hbw14aib5lz.cloudfront.net/310519663520822653/gck96ofZSr9RHT3ULk9Y66/water-pump-face-crop2_bb906eaf_fa6a9bb6.png", objPos: "object-top" },
              { icon: Stethoscope, title: "Treatable Diseases", text: "Treatable diseases still claim thousands of lives each year", img: "https://d36hbw14aib5lz.cloudfront.net/310519663520822653/gck96ofZSr9RHT3ULk9Y66/treatable-diseases-photo_28f423e9_51cc624a.png", objPos: "" },
            ].map((item, i) => (
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="relative">
              <img src="https://d36hbw14aib5lz.cloudfront.net/310519663520822653/gck96ofZSr9RHT3ULk9Y66/venture-philanthropy_baed5f58_f2432564.png" alt="SCF community program" className="rounded-lg shadow-2xl w-full" />
      ...
      <AnimatedSection className="py-20 md:py-28 bg-[#f5f7fb]">
        <div className="container">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
            {[
              { src: "https://d36hbw14aib5lz.cloudfront.net/310519663520822653/gck96ofZSr9RHT3ULk9Y66/africa-community_e5d09f33_032e9dd5.png", label: "Uganda" },
              { src: "https://d36hbw14aib5lz.cloudfront.net/310519663520822653/gck96ofZSr9RHT3ULk9Y66/girls-smiling_a37fc95e_21947ded.png", label: "India" },
              { src: "https://d36hbw14aib5lz.cloudfront.net/310519663520822653/gck96ofZSr9RHT3ULk9Y66/peru-family_e1da7a0a_1f59ed20.png", label: "Guatemala" },
              { src: "https://d36hbw14aib5lz.cloudfront.net/310519663520822653/gck96ofZSr9RHT3ULk9Y66/feeding-program_2769e285_0c652830.png", label: "Philippines" },
            ].map((item, i) => (
              <div key={i} className="relative group overflow-hidden rounded-lg aspect-[4/3]">
                ...
                <span className="absolute bottom-3 left-4 font-body text-white text-base font-semibold tracking-wide">{item.label}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      <AnimatedSection className="py-20 md:py-28 bg-white">
        <div className="container">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 items-stretch">
            {[
              { icon: Stethoscope, title: "Essential Healthcare Access", desc: "Clinics, mobile health vans, and hospitals providing care to underserved communities.", img: "https://d36hbw14aib5lz.cloudfront.net/310519663520822653/gck96ofZSr9RHT3ULk9Y66/pillar-healthcare_f9271335_91ca5fd7.png" },
              { icon: Heart, title: "Safe Care for Vulnerable Children", desc: "Children's homes, orphanages, and support programs giving children safety and hope.", img: "https://d36hbw14aib5lz.cloudfront.net/310519663520822653/gck96ofZSr9RHT3ULk9Y66/pillar-safe-care_924b56c5_c99318d8.png" },
              { icon: Baby, title: "Maternal & Child Nutrition", desc: "Programs helping severely malnourished children recover and thrive.", img: "https://d36hbw14aib5lz.cloudfront.net/310519663520822653/gck96ofZSr9RHT3ULk9Y66/mother-baby_f6648b22_a038e3cc.jpg" },
              { icon: Droplets, title: "Clean Water, Sanitation & Hygiene", desc: "Fresh water wells and sanitation systems bringing safe water to communities.", img: "https://d36hbw14aib5lz.cloudfront.net/310519663520822653/gck96ofZSr9RHT3ULk9Y66/pillar-clean-water-crop_bcabe271_f1149d67.png" },
              { icon: Eye, title: "Life-Changing Surgeries & Specialty Care", desc: "Cleft palate repairs, eye surgeries, clubfoot corrections, and prosthetics.", img: "https://d36hbw14aib5lz.cloudfront.net/310519663520822653/gck96ofZSr9RHT3ULk9Y66/surgery-room_5bf1238e_11aecfd8.png" },
              { icon: GraduationCap, title: "Education & Opportunity", desc: "Schools, textbooks, and vocational programs opening doors for children.", img: "https://d36hbw14aib5lz.cloudfront.net/310519663520822653/gck96ofZSr9RHT3ULk9Y66/pillar-education_7b8b8d1c_16904676.png" },
            ].map((pillar, i) => (
              <div key={i} className="group relative overflow-hidden rounded-lg flex flex-col h-full">
                ...
                <div className="p-6 bg-white border border-gray-100 flex-1">
                  ...
                  <p className="font-body text-[#3e4c59] text-base leading-relaxed">{pillar.desc}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <AnimatedSection className="relative py-20 md:py-28 overflow-hidden">
        <div className="absolute inset-0">
          <img src="https://d36hbw14aib5lz.cloudfront.net/310519663520822653/gck96ofZSr9RHT3ULk9Y66/volunteer-africa_0323e985_21479284.png" alt="Volunteer with children" className="w-full h-full object-cover" />
        ...
        <div className="relative container">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <Link href="/stories" className="inline-flex items-center gap-2 px-8 py-3.5 bg-[#D4A853] hover:bg-[#c49a45] text-[#12365a] font-body font-bold text-base tracking-wide rounded transition-all hover:shadow-lg">
              SEE MORE STORIES
              <ArrowRight size={16} />
            </Link>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
            {[
              ...
              <div key={i} className="bg-white rounded-lg p-6 text-center shadow-sm hover:shadow-md transition-shadow border border-gray-100">
                ...
                <p className="font-body text-[#3e4c59] text-base">{item.desc}</p>
              </div>
            ))}
          </div>
        </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 mb-8">
                {[
                  ...
                  <div key={i} className="bg-white/5 border border-white/10 rounded-lg p-5">
                    ...
                    <p className={`font-body text-base leading-relaxed ${item.gold ? 'text-[#D4A853]' : 'text-white/60'}`}>{item.desc}</p>
                  </div>
                ))}
              </div>
              <Link href="/angels-of-light" className="inline-flex items-center gap-2 px-8 py-3.5 bg-[#D4A853] hover:bg-[#c49a45] text-[#12365a] font-body font-bold text-base tracking-wide rounded transition-all hover:shadow-lg">
